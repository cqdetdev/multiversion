...
func StackRequest(r *protocol.Reader, x *ItemStackRequest) {
	var count uint32
...
func StackResponse(r *protocol.Reader, x *ItemStackResponse) {
	var l uint32
	r.Uint8(&x.Status)
	r.Varint32(&x.RequestID)
	if x.Status != ItemStackResponseStatusOK {
...
func StackContainerInfo(r *protocol.Reader, x *StackResponseContainerInfo) {
	var l uint32
...
// StackSlotInfo reads/writes a StackResponseSlotInfo x using protocol.IO r.
func StackSlotInfo(r protocol.IO, x *StackResponseSlotInfo) {
	r.Uint8(&x.Slot)
...
// Unmarshal ...
func (a *transferStackRequestAction) Unmarshal(r *protocol.Reader) {
	r.Uint8(&a.Count)
...
// Unmarshal ...
func (a *SwapStackRequestAction) Unmarshal(r *protocol.Reader) {
	StackReqSlotInfo(r, &a.Source)
	StackReqSlotInfo(r, &a.Destination)
}
...
// Unmarshal ...
func (a *DropStackRequestAction) Unmarshal(r *protocol.Reader) {
	r.Uint8(&a.Count)
	StackReqSlotInfo(r, &a.Source)
	r.Bool(&a.Randomly)
}
...
// Unmarshal ...
func (a *DestroyStackRequestAction) Unmarshal(r *protocol.Reader) {
	r.Uint8(&a.Count)
	StackReqSlotInfo(r, &a.Source)
}
...
// Unmarshal ...
func (a *CreateStackRequestAction) Unmarshal(r *protocol.Reader) {
...
// Unmarshal ...
func (a *BeaconPaymentStackRequestAction) Unmarshal(r *protocol.Reader) {
...
// Unmarshal ...
func (a *CraftRecipeStackRequestAction) Unmarshal(r *protocol.Reader) {
...
// Unmarshal ...
func (a *CraftCreativeStackRequestAction) Unmarshal(r *protocol.Reader) {
...
// StackReqSlotInfo reads/writes a StackRequestSlotInfo x using protocol.IO r.
